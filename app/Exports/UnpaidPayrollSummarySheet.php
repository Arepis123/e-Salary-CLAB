...
class UnpaidPayrollSummarySheet implements FromCollection, WithColumnWidths, WithHeadings, WithMapping, WithStyles, WithTitle
{
    protected $data;
    ...
    public function map($item): array
    {
        ...
        return [
            ...
            $this->formatCurrency($item['total_due']),
            $statusLabel,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('1:1')->applyFromArray([
            ...
            'fill' => [
                ...
                'startColor' => ['rgb' => 'F59E0B'], // Amber/Orange color for unpaid
            ],
            'alignment' => [
