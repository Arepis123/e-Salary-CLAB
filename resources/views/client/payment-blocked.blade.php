{{-- Standalone Cloudflare-style error page shown when an admin has disabled
     payments for a contractor. Layout/CSS adapted from
     https://github.com/donlon/cloudflare-error-page (MIT). The CSS below is
     wrapped in a verbatim block so Blade does not parse its media at-rules. --}}
<!DOCTYPE html>
...
<div id="cf-wrapper">
    <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
            ...
            <div>
                Visit <a href="{{ route('dashboard') }}">{{ $host }}</a> for more information.
            </div>
          ...
          <div class="w-240 lg:w-full mx-auto">
                <div class="clearfix md:px-8">
                    ...
                    <div id="cf-cloudflare-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
                        ...
                        <span class="md:block w-full truncate">{{ $cloudflareLocation }}</span>
        ...
        <div class="w-240 lg:w-full mx-auto mb-8 lg:px-8">
            <div class="clearfix">
                <div class="w-1/2 md:w-full float-left pr-6 md:pb-10 md:pr-0 leading-relaxed">
                    ...
                    <p>This website is using a security service to protect itself from online attacks. The action you just performed triggered the security solution and your request was blocked.</p>
                </div>
                <div class="w-1/2 md:w-full float-left leading-relaxed">
                    <h2 class="text-3xl font-normal leading-1.3 mb-4">What can I do?</h2>
                    <p>You can try again in a few minutes. If the problem persists, please contact the site administrator and provide the Ray ID below. You can <a href="{{ route('dashboard') }}">return to your dashboard</a> in the meantime.</p>
                </div>
            </div>
        </div>
        ...
        <div class="cf-error-footer cf-wrapper w-240 lg:w-full py-10 sm:py-4 sm:px-8 mx-auto text-center sm:text-left border-solid border-0 border-t border-gray-300">
            <p class="text-13">
                <span class="cf-footer-item sm:block sm:mb-1">Ray ID: <strong class="font-semibold">{{ $rayId }}</strong></span>
                <span class="cf-footer-separator sm:hidden">&bull;</span>
                <span class="cf-footer-item sm:block sm:mb-1">Host: <strong class="font-semibold">{{ $host }}</strong></span>
                <span class="cf-footer-separator sm:hidden">&bull;</span>
